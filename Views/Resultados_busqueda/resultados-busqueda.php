...
?>
  ...
  <!-- FUNCION PARA PROPIEDADES SUPER DESTACADAS -->
  <div class="col-xxl-12">
    <!-- Esta funcion Imprime todas las propiedades -->
    <div class="ad-content-property card" onmouseover="handleHoverProperty(<?= $propiedad['idpropiedad'] ?>)">
...
<div class="mt-1 mt-lg" id="main-wrapper">
  <div class="recent-article-area" style="overflow-x: hidden;">
    <div class="form-row">
      <div class="col-lg-6" style="height: calc(100vh - 110px); max-height: calc(100vh - 110px);">
        <div id="map"></div>
        <div style="display: none">
          <div class="controls zoom-control">
            <a href="#" class="zoom-control-in" title="Zoom In"><i class='bx bx-plus-medical'></i>
            </a>
          ...
          <div class="controls maptype-control maptype-control-is-map">
            ...
            <!-- <a href="#" class="maptype-control-map">
              <i class='bx bx-chevron-left' style="font-size: 17.5px; vertical-align:middle;"></i>
      ...
      <div class="col-lg-6" style="overflow-y: scroll; height: calc(100vh - 110px);">
        <!-- AQUI EMPIEZAN LOS BOTONES -->
        <button type="button" class="btn btn-primary mt-2 sombra-btn font-weight-bold" data-bs-toggle="modal" data-bs-target="#FilterModal">
          Filtro
        </button>
        <div class="row">
          <!-- Modal -->
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 mt-lg-0 mt-3">
                      <select name="municipal" data-dropup-auto="false" data-size="5" id="municipal" title="Tds. Tipos" class="form-control selectpicker">
                        <?php $tipos = getTipos();
                    ...
                    <div class="col-xl-3 col-lg-6 mt-lg-0 mt-3">
                      <select name="municipal" data-dropup-auto="false" data-size="5" id="municipal" title="Tds. Municipales" class="form-control selectpicker">
                      </select>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 mt-lg-3 mt-xl-0 mt-3">
                      <select name="area" data-dropup-auto="false" data-size="5" id="area" title="Tds. Areas" class="form-control selectpicker">
                    ...
                    <div class="col-md-12">
                      <button class="btn box-shadow-none" type="button" data-bs-toggle="collapse" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                          ...
                          for ($i = 0; $i < $count; $i++) {
                            ...
                            <div class="col-md-3 col-sm-6 col-12">
                              <div class="animated-checkbox">
                                <label id="caracteristica-<?= $caracteristica['idcheck'] ?>">
                                  <input type="checkbox" <?= checkCaracacterstica($caracteristicasjson, $caracteristica['titulo']) ? 'checked' : null ?> name="caracteristicas[<?= $i ?>]<?= $caracteristica['idcheck'] ?>" value="<?= $caracteristica['titulo'] ?>"><span class="label-text">
...
<script>
  ...
  ?>
    let coord = {
      ...
      lng: parseFloat(<?= $propiedad['longitud_mapa'] ?>) === NaN ? 0 : parseFloat(<?= $propiedad['longitud_mapa'] ?>),
    };
...
<script src="https://maps.googleapis.com/maps/api/js?key=<?= KEYGOOGLEMAPS ?>&libraries=places&callback=iniciarMap">
</script>