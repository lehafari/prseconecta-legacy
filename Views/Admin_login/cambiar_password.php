        ...
        <form class="formulario" name="formCambiarPass" id="formCambiarPass">
            ...
            <div>
                <div class="input-group">
                    ...
                    <label class="label" for="password"><i class='bx bxs-lock-alt'></i> Password:</label>
                </div>
                <div class="input-group">
                    <input type="password" id="passwordConfirm" name="passwordConfirm">
                    <label class="label" for="passwordConfirm"><i class='bx bxs-lock-alt'></i>Confirm Password:</label>
                </div>
