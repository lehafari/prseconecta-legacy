<?php if (($_SESSION['permisosMod']['w']) || $_SESSION['permisosMod']['u']) { ?>
    <div class="modal fade" id="modalFormAgentes" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formAgentes" class="form-horizontal" name="formAgentes">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label class="control-label" for="apellido">Last Name <span class="required">*</span></label>
                                <input class="form-control form-control-sm" id="apellido" name="apellido" type="text" placeholder="Last Name">
                            </div>
                        </div>
