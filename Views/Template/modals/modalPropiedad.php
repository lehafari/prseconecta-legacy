...
?>
<div class="modal fade" id="modalPropiedad" lat="<?= floatval($propiedad['latitud_mapa']) ?  $propiedad['latitud_mapa'] : 18.200178 ?>" long="<?= floatval($propiedad['longitud_mapa']) ? $propiedad['longitud_mapa'] : -66.664513 ?>">
      ...
      <div class="modal-body p-0">
          ...
          <div class="col-lg-8">
            ...
            <?php if (!empty($propiedad['imagenes'])) { ?>
              <?php if (count($propiedad['imagenes']) === 1) { ?>
                <div class="contenedor-imagenes-masonry" style="overflow-y: scroll; ">
                  <div class="d-flex align-items-center">
                    <img style="width: 100%;" class="img-fluid" src="<?= media() ?>/images/uploads/<?= $propiedad['imagenes'][0]['rutaimagen'] ?>" alt="Imagen propiedad <?= $propiedad['titulo'] ?>">
                  </div>
                </div>
                ...
                <ul class="contenedor-imagenes-masonry">
                  <?php foreach ($propiedad['imagenes'] as $key => $imagen) { ?>
                    <li class="elemento <?= $key === 0 ? 'prominent' : '' ?>">
                      <img src="<?= media() ?>/images/uploads/<?= $imagen['rutaimagen'] ?>" alt="Imagen propiedad <?= $propiedad['titulo'] ?>">
                    </li>
                  <?php } ?>
                </ul>
            <?php  }
          ...
          <div class=" col-lg-4 py-2 px-4 border-left">
            <div class="modal-header d-block">
              <div class="d-flex justify-content-between">
                <img style="width: 100px;" src="<?= media() ?>/images/PRSC_Comercial.png" alt="">
                <div>
                  <div class="btn-group">
                  ...
                  <div class=" btn-group dropleft">
                    <button type="button" class="btn btn-sm ml-2 p-0 dropdown-toggle" data-toggle="dropdown" aria-haspopup="false" aria-expanded="false">
            ...
            <?php if (!empty($propiedad['subtipo']['titulo'])) { ?>
              <h5 class="card-title d-flex align-items-center mt-1">
                <span class="mr-1">
                  <i style="font-size: 10px;" class='bx bxs-circle text-danger mb-2'></i>
                </span>
                <?= $propiedad['subtipo']['titulo'] ?>
              </h5>
            <?php } ?>

            <div class="d-flex justify-content-between <?= !empty($propiedad['direccion_localizacion']) ? 'pb-4' : '' ?>">
            ...
            <?php if (!empty($propiedad['direccion_localizacion'])) { ?>
              <p>
                <img style="width: 20px;" src="<?= media() ?>/images/puerto-rico.svg" alt="puerto-rico">
            ...
            <div class="d-flex modal-box-nav ">
              ...
              <div>
                <a href="#general" data-id-modal-box-nav="1" class="active" style="font-size: 12px;">General</a>
              </div>
              <div>
              ...
              <div>
                <a data-id-modal-box-nav="3" href="#caracteristicas" style="font-size: 12px;">Caracteristicas</a>
              </div>
            ...
            <div id="detallesPropiedad" style="overflow-y: scroll; height: 425px">
              ...
              <section id="general" class="my-3 mr-3">
                ...
                <div class="d-flex justify-content-end align-items-center mt-4">
                  <div>
                    <span>
                      <i style="color: #08c0ff; font-size: 20px; vertical-align: middle;" class='bx bxs-show'></i>
                    ...
                    <span>
                      <i style="color: #08c0ff; font-size: 20px; vertical-align: middle;" class='bx bxs-calendar'></i> Publicado hace 4 meses
                    </span>
                  </div>
                </div>
              </section>
                ...
                if (!empty($formbuilderjson) && !empty($propiedad['subtipo']['top_detail_field'])) { ?>
                  <div class="row pt-3 pb-5">
                    ...
                    foreach ($formbuilder as $form) { ?>
                      <div class="col-md-6 ">
                        <div class="d-flex">
                          <div class="p-1"><i style="font-size:10px;" class="bx bxs-circle text-info"></i> </div>
                ...
                ?>
                  <div class="my-4 d-flex">
                    ...
                    <div class="agent-image" style="box-shadow: none; border: 0.5px solid; ">
                      <span class="rounded">
                        <img src="<?= media() ?>/images/uploads/<?= $imagen ?>" alt="Imagen de perfil de: <?= $agente['usuario'] ?>">
                      </span>
                    </div>
                    <ul>
                      <li>
                  ...
                  <form id="formMensajePerfil">
                    <input type="hidden" name="idagente" value="<?= $agente['idpersona'] ?>">
                    <div class="form-group">
                      <input type="text" placeholder="Tú nombre" name="name" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <textarea class="form-control" name="mensaje" rows="4">Hola! <?= $agente['usuario'] ?>, ví tu perfil en PRSECONECTA y quería ver si podría ayudarme</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-check mb-3">
                      <input class="form-check-input" type="checkbox" id="checkterminosperfil">
                      <label class="form-check-label" for="checkterminosperfil">
                        Aceptar <a href="<?= base_url() ?>/Terminos-y-condiciones" class="text-info" target="_blank">
        ...
        <div class="swiper mySwiper1">
          <div class="swiper-wrapper">
            <?php print_r($data['listado-destacados'])  ?>;
