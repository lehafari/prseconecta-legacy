        ...
        <tbody>
            ...
            <tr>
                <td>
                    ...
                    <p>Access request for the user: <strong><?= $data['email']; ?></strong></p>
                    <p>You have requested your user data, access the link below to confirm your password.</p>
                    <p class="x_text_white">
                        <a href="<?= $data['url_recovery']; ?>" target="_blank"
                            class="x_button_link x_link_blue">Confirm Password</a>
                    </p>
                    <br>
                    <p>If the button does not work for you, you can copy and paste the following address in your
                        browser.</p>
