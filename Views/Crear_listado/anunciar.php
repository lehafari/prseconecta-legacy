...
<section class="home-section">
  ...
  <form id="formAnunciar" novalidate enctype="multipart/form-data">
    ...
    <section id="step2" class="" style="display:none">
      <div class="app-content">
        <div class="row">
          <div class="col-md-12">
              ...
              <div class="tile-body">
                ...
                <div class="form-group row my-5">
                  <div class="col-lg-5">
                    ...
                    <select data-size="5" title="Seleccione un tipo" name="tipo"
            ...
            <div class="tile rounded-0">
              <div class="tile-body">
                <div class="form-group">
                  ...
                  <input onkeyup="controlDecimal(event)" autocomplete="off"
            ...
            <div class="tile rounded-0">
              <div class="tile-body">
                <?= getFile(
                  ...
                  [
                    'formbuilder' => $data['subtipo']['formbuilder'],
                    'orden' => $data['subtipo']['ordern_enabled'],
                    'script' => false
                  ]
                ) ?>
              </div>
                  ...
                  <div class="col-lg-3 col-md-6 col-12">
                    <div class="animated-checkbox">
                      <label
                        ...
                        <input type="checkbox"
                          name="caracteristicas[<?= $caracteristica['idcheck'] ?>]"
              ...
              <div class="tile-body">
                <div class="form-row">
                  <div class="form-group col-lg-6">
                    ...
                    <div id="map"></div>
                    <button type="button"
                      class="btn btn-info btn-block mt-4">Coloque el pin
                      en la
                      dirección de arriba
                    </button>
                  </div>
