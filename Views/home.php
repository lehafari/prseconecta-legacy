...
<div id="main-wrapper">
  <div class="site-wrapper-reveal">
    <div class="hero-area-two-wrapper">
      <div class="hero-area-two hero-area-overly" <?php if (!empty($home['imagen'])) : ?> style="background-image: url(<?= media() ?>/images/uploads/<?= $home['imagen'] ?>);" <?php endif; ?> ?>>
        <div class="container">
          <div class="col-lg-12">
                    ...
                    <div class="card-body ">
                      <form id="form-cotizacion">
                        <div class="mb-3">
                          ...
                          <select title="Elegir" name="tipopropiedad" data-dropup-auto="false" data-size="5" id="tipopropiedad" class="form-control selectpicker">
                            <?php $tipos = getTipos();
                        ...
                        <div class="mb-3">
                          ...
                          <select title="Elegir" name="tipoestado" data-dropup-auto="false" data-size="5" id="tipoestado" class="form-control selectpicker">
                          </select>
                        </div>

                        <div class="mb-3">
                          <label for="municipal">Municipal</label>
                          <select title="¿Dónde?" name="municipal" data-dropup-auto="false" data-size="5" id="municipal" class="form-control selectpicker">
                        ...
                        <div class="mb-3">
                          ...
                          <select title="Ingrese el área" name="area" data-dropup-auto="false" data-size="5" id="area" class="form-control selectpicker">
                    ...
                    <div class="mb-3">
                      <div class="wrapper-slide">
                        ...
                        <div class="container-slide">
                          ...
                          <input type="range" min="0" max="50000000" value="0" id="slider-1" oninput="slideOne()">
                          <input type="range" min="0" max="50000000" value="50000000" id="slider-2" oninput="slideTwo()">
                        </div>
                      </div>
  ...
  <div class="bg-destacados">
    <?php if (!empty($data['listado-superDestacados'])) { ?>
      ...
      <div class="swiper swiperDestacados">
              ...
              <div class="ad-property card">
                <?php if (!empty($propiedad['imagenes'])) { ?>
                  <a class="img-sombra" href="<?= $rutaPropiedad ?>">
                    <div class="position-absolute w-100 d-flex justify-content-end pt-3">
                      <img width="45px" src="<?= media() ?>/images/award.svg" alt="Award">
                    </div>
                    ...
                    <img src="<?= media() ?>/images/uploads/<?= $propiedad['imagenes'][0]['rutaimagen'] ?>" class="card-img-top" alt="Listado propiedad">
                  </a>
                <?php } ?>
                <div class="card-body p-2">

                  <h5 class="card-title font-weight-normal d-flex justify-content-between">
                  ...
                  <h5 class="card-title d-flex align-items-center">
                    <span class="<?= empty($propiedad['subtipo']['titulo']) ? 'text-light' : 'text-danger' ?> mr-1">
                  ...
                  <div class="container py-4">
                    <div class="row">
                      ...
                      ?>
                          <div class="w-33 text-center mx-auto" style="border-right: 1px solid #cccc;">
                ...
                <div class="card-footer p-2 d-flex justify-content-between">
                  <a style="font-size: 13px;" href="<?= base_url() ?>/agentes/agente/<?= $propiedad['rutausuario'] ?>" class="text-info font-weight-normal">
                    <i class='bx bx-user'></i>
                    <?= $propiedad['email_user'] ?>
                  </a>

                  <span style="font-size: 13px;" class="font-weight-normal text-dark">
        ...
        <div class="swiper-pagination-destacados d-flex justify-content-center mt-4">
        </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="section-title text-center section-border-bottom">
          <img width="50px" class="mt-5" src="<?= media() ?>/images/award.svg" alt="Award">
          ...
          <ul class="icon-destacado">
            ...
            foreach ($arrDestacadosPropiedadesComerciales as $p) { ?>
              <li>
                <img src="<?= media() ?>/images/arrow-right.svg" alt="Arrow Right">
                <p>
                  <?= $p ?>
                </p>
              </li>
...
<div id="banner" <?php if (!empty($banner['imagen'])) : ?> style="background-image: url(<?= media() ?>/images/uploads/<?= $banner['imagen'] ?>);" <?php endif; ?> class="recent-article-area section-space--pb_120 mb-5">
      ...
      <div class="contenedor-banner" data-aos="fade-down">
        <div class="row justify-content-end">
          ...
          <div class="col-lg-4 text-center">
            <img width="300px" src="<?= media() ?>/images/companialocal.png" alt="">
          </div>
        </div>
      </div>
    </div>
                  ...
                  <div class="ad-content-property card">
                    <?php if (!empty($propiedad['imagenes'])) { ?>
                      <a class="img-sombra" href="<?= $rutaPropiedad ?>">
                        ...
                        <img src="<?= media() ?>/images/uploads/<?= $propiedad['imagenes'][0]['rutaimagen'] ?>" class="card-img-top" alt="Imagen propiedad de: <?= $propiedad['titulo'] ?>">
                      </a>
                    <?php } ?>
                    <div class="card-body p-2">
                    ...
                    <div class="card-footer p-2">
                      <a href="<?= base_url() ?>/agentes/agente/<?= $propiedad['rutausuario'] ?>" class="text-info">
                        <i class='bx bx-user'></i>
                        <?= $propiedad['email_user'] ?>
                      </a>
                  ...
                  <div class="ad-content-property card">
                    <?php if (!empty($propiedad['imagenes'])) { ?>
                      <a class="img-sombra" href="<?= $rutaPropiedad ?>">
                        ...
                        <img src="<?= media() ?>/images/uploads/<?= $propiedad['imagenes'][0]['rutaimagen'] ?>" class="card-img-top" alt="Imagen de: <?= $propiedad['titulo'] ?>">
                      </a>
                    <?php } ?>
                    <div class="card-body p-2">
                      <h5 class="card-title d-flex justify-content-between">
                    ...
                    <div class="card-footer p-2">
                      <a style="font-size: 12px;" href="<?= base_url() ?>/agentes/agente/<?= $propiedad['rutausuario'] ?>" class="text-info">
