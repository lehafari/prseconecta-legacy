...
<div class="mt-5 mt-lg-0 pt-5" id="main-wrapper">
  ...
  <div
    class="recent-article-area my-5 p-3 p-md-5 <!-- <?php if (!empty($agente['custombg'])) echo 'bg-custom' ?> -->"
    <?php if (!empty($agente['custombg'])) { ?> style="background-image: url();"
    <?php } ?>>
    <div class="container-lg">
      <div class="tile mb-0">
        <div class="tile-body">
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="pt-2">
                <button data-toggle="modal" data-target="#modal-mensaje-perfil"
        ...
        <div class="col-md-8">
          ...
          <div class="tile">
            <div class="tile-body">
              ...
              <ul class="nav nav-pills pt-4" id="pills-tab" role="tablist">
                <li class="nav-item border-0 w-50 pr-2" role="presentation">
              ...
              <div class="tab-content" id="tabContent-agent">
                <div class="tab-pane fade show active" id="pills-propiedades"
                  role="tabpanel" aria-labelledby="pills-propiedades-tab">
                  <div class="container-fluid pt-4">
                    <h3 class="text-center">Este usuario todavía no ha subido
                      propiedades</h3>
                  </div>
                </div>
                <div class="tab-pane fade" id="pills-reviews" role="tabpanel"
                  ...
                  <div class="container-fluid pt-4">
                    ...
                    <h3 class="text-center">Para poder comentar tienes que haber
                      iniciado sesión</h3>
                    <p class="text-center">¡También puedes calificar al agente!
                    </p>
                    ...
                    <form id="frm-reviews" class="mt-2">
                      <div class="alert divAlertReviews" style="display: none;">
                        <p class="text-danger">
                    ...
                    <div class="mt-4" id="comentarios">
                      ...
                      <div id="mensajenohaycomentarios">
                        <h3 class="text-center">Todavia no hay comentarios</h3>
            ...
            <div class="tile">
              <div class="tile-body">
                ...
                <div>
                      ...
                      <div class="swiper-slide">
                        <div class="ad-content-property card">
                          <a class="img-sombra" href="<?= base_url() ?>">
                            ...
                            <img src="<?= media() ?>/images/prueba2.png"
                  ...
                  <div
                    class="swiper-pagination1 d-flex justify-content-center pb-5">
                  </div>
                </div>
